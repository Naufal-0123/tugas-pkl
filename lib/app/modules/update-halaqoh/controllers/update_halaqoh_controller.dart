...
class UpdateHalaqohController extends GetxController {
  ...
  RxString surat2 = "".obs;
  RxString waktu = "".obs;
  RxString judul = "Update Halaqoh".obs;
  ...
  void onInit() {
    ...
    surat.value = (data.data() as Map<String, dynamic>)['dariSurat'];
    surat2.value = (data.data() as Map<String, dynamic>)['sampaiSurat'];
    waktu.value = (data.data() as Map<String, dynamic>)['waktuHalaqoh'];
    print(surat);
    super.onInit();
  }
